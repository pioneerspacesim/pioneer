...
def main():
    ...
    outfile.write('/* THIS FILE IS AUTO-GENERATED, CHANGES WILL BE OVERWRITTEN */\n')
    outfile.write('/* enum table generated by scan_enums.py */\n\n')
    outfile.write('struct EnumItem { const char *name, int value };\n\n')
    for e in enums:
        e.write_c_table(outfile)
        outfile.write('\n')
