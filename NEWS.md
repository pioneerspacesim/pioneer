...
<img width="2560" height="1440" alt="Image" src="https://github.com/user-attachments/assets/6d1b8e04-ba55-4790-b09b-f08d628cbadf" />

### Thruster Plumes & Shield Heating

<img width="2560" height="1440" alt="image" src="https://github.com/user-attachments/assets/8c4f92b2-fc0f-4bd5-9e64-d47b3d51c3bc" />

# User Interface

### Flight Reticle and Radar Landing Aids

<img width="2560" height="1440" alt="image" src="https://github.com/user-attachments/assets/ac2ffc2e-b2f3-47bf-82b1-ab0f8978cf2a" />
...
<img width="2560" height="1440" alt="image" src="https://github.com/user-attachments/assets/fc0b3837-9727-4608-ad58-220fb9738c65" />
...
* Fix ImGui error message of extending parent boundaries with `SetCursorPos` (#6380)
* BulkShips fix for running out of parking slots (#6385)
...
* Fix overlapping craters, and early out of `GetHeights` (#6292)
* Fix News debug window supporting multiple 'delete' advert buttons (#6308)
