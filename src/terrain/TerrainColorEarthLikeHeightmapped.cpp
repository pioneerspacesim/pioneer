...
template <>
TerrainColorFractal<TerrainColorEarthLikeHeightmapped>::TerrainColorFractal(const SystemBody *body) : Terrain(body)
{
	// crappy water
...
template <>
void TerrainColorFractal<TerrainColorEarthLikeHeightmapped>::GetColor(const vector3d &p, const double height, const vector3d &norm, Color3ub &out) const
{
