...
template <>
TerrainHeightFractal<TerrainHeightMountainsRiversVolcano>::TerrainHeightFractal(const SystemBody *body, const Uint32 surfaceEffects, const ETerrainColours terrainColour) :
	Terrain(body, surfaceEffects, terrainColour)
{
	...
	// volcano
	SetFracDef(7, 20000.0, 5000000.0, 100.0);

	// canyons and rivers
	SetFracDef(8, m_maxHeightInMeters * 1.0, 4e6, 100.0);
	SetFracDef(9, m_maxHeightInMeters * 1.0, 5e6, 100.0);
