...
template <>
void TerrainColorFractal<TerrainColorRock2>::GetColor(const vector3d &p, const double height, const vector3d &norm, Color3ub &out) const
{
	double n = m_invMaxHeight*height/2;
	if (n <= 0) {
		SetColour(out, m_darkrockColor[0]); return;
	}
