...
TerrainHeightFractal<TerrainHeightMountainsRidged>::TerrainHeightFractal(const SBody *body) : Terrain(body)
{
	...
	SetFracDef(1, m_maxHeightInMeters, m_rand.Double(50.0, 100.0)*m_maxHeightInMeters, m_rand, 8*m_fracmult);
	SetFracDef(2, height, m_rand.Double(4.0, 200.0)*height, m_rand, 10*m_fracmult);
	SetFracDef(3, m_maxHeightInMeters, m_rand.Double(120.0, 2000.0)*m_maxHeightInMeters, m_rand, 1000*m_fracmult);

	height = m_maxHeightInMeters*0.4;
	SetFracDef(4, m_maxHeightInMeters, m_rand.Double(100.0, 200.0)*m_maxHeightInMeters, m_rand);
	SetFracDef(5, height*0.4, m_rand.Double(2.5,30.5)*height, m_rand);
	SetFracDef(6, height*0.2, m_rand.Double(20.5,350.5)*height, m_rand, 10000*m_fracmult);

	SetFracDef(7, m_maxHeightInMeters, m_rand.Double(100.0, 2000.0)*m_maxHeightInMeters, m_rand, 100*m_fracmult);
	SetFracDef(8, height*0.3, m_rand.Double(2.5,300.5)*height, m_rand, 500*m_fracmult);
	SetFracDef(9, height*0.2, m_rand.Double(2.5,300.5)*height, m_rand, 20*m_fracmult);
}
