...
template <>
void TerrainColorFractal<TerrainColorGGNeptune>::GetColor(const vector3d &p, const double height, const vector3d &norm, Color3ub &out) const
{
	...
	n /= 2.0;
	n *= n*n;
	SetColour(out, interpolate_color(n, vector3d(.04, .05, .15), vector3d(.80,.94,.96)));
}
