...
template <>
TerrainHeightFractal<TerrainHeightHillsCraters2>::TerrainHeightFractal(const SBody *body) : Terrain(body)
{
	...
	SetFracDef(3, m_maxHeightInMeters*0.07, 11e5, m_rand, 1000.0*m_fracmult);
	SetFracDef(4, m_maxHeightInMeters*0.05, 98e4, m_rand, 800.0*m_fracmult);
	SetFracDef(5, m_maxHeightInMeters*0.05, 1e6, m_rand, 400.0*m_fracmult);
	SetFracDef(6, m_maxHeightInMeters*0.04, 99e4, m_rand, 200.0*m_fracmult);
	SetFracDef(7, m_maxHeightInMeters*0.05, 12e5, m_rand, 100.0*m_fracmult);
	SetFracDef(8, m_maxHeightInMeters*0.04, 9e5, m_rand, 100.0*m_fracmult);
}
