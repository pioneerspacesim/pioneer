...
const struct EnumItem ENUM_BodyType[] = {
	{ "GRAVPOINT", int(GalaxyEnums::BodyType::TYPE_GRAVPOINT) },
	{ "BROWN_DWARF", int(GalaxyEnums::BodyType::TYPE_BROWN_DWARF) },
	{ "WHITE_DWARF", int(GalaxyEnums::BodyType::TYPE_WHITE_DWARF) },
	{ "STAR_M", int(GalaxyEnums::BodyType::TYPE_STAR_M) },
	{ "STAR_K", int(GalaxyEnums::BodyType::TYPE_STAR_K) },
	{ "STAR_G", int(GalaxyEnums::BodyType::TYPE_STAR_G) },
	{ "STAR_F", int(GalaxyEnums::BodyType::TYPE_STAR_F) },
	{ "STAR_A", int(GalaxyEnums::BodyType::TYPE_STAR_A) },
	{ "STAR_B", int(GalaxyEnums::BodyType::TYPE_STAR_B) },
	{ "STAR_O", int(GalaxyEnums::BodyType::TYPE_STAR_O) },
	{ "STAR_M_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_M_GIANT) },
	{ "STAR_K_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_K_GIANT) },
	{ "STAR_G_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_G_GIANT) },
	{ "STAR_F_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_F_GIANT) },
	{ "STAR_A_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_A_GIANT) },
	{ "STAR_B_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_B_GIANT) },
	{ "STAR_O_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_O_GIANT) },
	{ "STAR_M_SUPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_M_SUPER_GIANT) },
	{ "STAR_K_SUPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_K_SUPER_GIANT) },
	{ "STAR_G_SUPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_G_SUPER_GIANT) },
	{ "STAR_F_SUPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_F_SUPER_GIANT) },
	{ "STAR_A_SUPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_A_SUPER_GIANT) },
	{ "STAR_B_SUPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_B_SUPER_GIANT) },
	{ "STAR_O_SUPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_O_SUPER_GIANT) },
	{ "STAR_M_HYPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_M_HYPER_GIANT) },
	{ "STAR_K_HYPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_K_HYPER_GIANT) },
	{ "STAR_G_HYPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_G_HYPER_GIANT) },
	{ "STAR_F_HYPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_F_HYPER_GIANT) },
	{ "STAR_A_HYPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_A_HYPER_GIANT) },
	{ "STAR_B_HYPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_B_HYPER_GIANT) },
	{ "STAR_O_HYPER_GIANT", int(GalaxyEnums::BodyType::TYPE_STAR_O_HYPER_GIANT) },
	{ "STAR_M_WF", int(GalaxyEnums::BodyType::TYPE_STAR_M_WF) },
	{ "STAR_B_WF", int(GalaxyEnums::BodyType::TYPE_STAR_B_WF) },
	{ "STAR_O_WF", int(GalaxyEnums::BodyType::TYPE_STAR_O_WF) },
	{ "STAR_S_BH", int(GalaxyEnums::BodyType::TYPE_STAR_S_BH) },
	{ "STAR_IM_BH", int(GalaxyEnums::BodyType::TYPE_STAR_IM_BH) },
	{ "STAR_SM_BH", int(GalaxyEnums::BodyType::TYPE_STAR_SM_BH) },
	{ "PLANET_GAS_GIANT", int(GalaxyEnums::BodyType::TYPE_PLANET_GAS_GIANT) },
	{ "PLANET_ASTEROID", int(GalaxyEnums::BodyType::TYPE_PLANET_ASTEROID) },
	{ "PLANET_TERRESTRIAL", int(GalaxyEnums::BodyType::TYPE_PLANET_TERRESTRIAL) },
	{ "STARPORT_ORBITAL", int(GalaxyEnums::BodyType::TYPE_STARPORT_ORBITAL) },
	{ "STARPORT_SURFACE", int(GalaxyEnums::BodyType::TYPE_STARPORT_SURFACE) },
	{ 0, 0 },
};

const struct EnumItem ENUM_BodySuperType[] = {
	{ "NONE", int(GalaxyEnums::BodySuperType::SUPERTYPE_NONE) },
	{ "STAR", int(GalaxyEnums::BodySuperType::SUPERTYPE_STAR) },
	{ "ROCKY_PLANET", int(GalaxyEnums::BodySuperType::SUPERTYPE_ROCKY_PLANET) },
	{ "GAS_GIANT", int(GalaxyEnums::BodySuperType::SUPERTYPE_GAS_GIANT) },
	{ "STARPORT", int(GalaxyEnums::BodySuperType::SUPERTYPE_STARPORT) },
	{ 0, 0 },
};
