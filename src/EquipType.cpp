...
const LaserType Equip::lasers[] = {
	{
		...
		8.0f, 10000.0f, 1000.0f, 0.25f, 30.0f, 5.0f, 0,
		Color(1.0f, 0.2f, 0.2f, 1.0f),
	},{		// 1mw df pulse
		8.0f, 10000.0f, 1000.0f, 0.25f, 30.0f, 5.0f, Equip::LASER_DUAL,
		Color(1.0f, 0.2f, 0.2f, 1.0f),
	},{	// 2mw pulse
		8.0f, 10000.0f, 2000.0f, 0.25f, 30.0f, 5.0f, 0,
		Color(1.0f, 0.5f, 0.2f, 1.0f),
	},{	// 2mw rf pulse
		8.0f, 10000.0f, 2000.0f, 0.13f, 30.0f, 5.0f, 0,
		Color(1.0f, 0.5f, 0.2f, 1.0f),
	},{		// 4mw pulse
		8.0f, 10000.0f, 4000.0f, 0.25f, 30.0f, 5.0f, 0,
		Color(1.0f, 1.0f, 0.2f, 1.0f),
	},{		// 10mw pulse
		8.0f, 10000.0f, 10000.0f, 0.25f, 30.0f, 5.0f, 0,
		Color(0.2f, 1.0f, 0.2f, 1.0f),
	},{		// 20mw pulse
		8.0f, 10000.0f, 20000.0f, 0.25f, 30.0f, 5.0f, 0,
		Color(0.1f, 0.2f, 1.0f, 1.0f),
	},{		// 17mw mining
		8.0f, 10000.0f, 17000.0f, 2.0f, 30.0f, 5.0f, Equip::LASER_MINING,
		Color(0.2f, 0.5f, 1.0f, 1.0f),
	},{		// small plasma accel
		8.0f, 10000.0f, 50000.0f, 0.3f, 42.0f, 7.0f, 0,
		Color(0.2f, 1.0f, 1.0f, 1.0f),
	},{		// large plasma accel
		8.0f, 10000.0f, 100000.0f, 0.3f, 54.0f, 9.0f, 0,
