...
template <>
const char *LuaObject<GameUI::KeyBindingCapture>::s_type = "UI.Game.KeyBindingCapture";
template <>
void LuaObject<GameUI::KeyBindingCapture>::RegisterClass()
{
...
template <>
const char *LuaObject<GameUI::AxisBindingCapture>::s_type = "UI.Game.AxisBindingCapture";
template <>
void LuaObject<GameUI::AxisBindingCapture>::RegisterClass()
{
	static const char *l_parent = "UI.Single";
