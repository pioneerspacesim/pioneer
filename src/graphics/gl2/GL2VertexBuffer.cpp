...
void InstanceBuffer::Bind() {
	...
	glVertexAttribDivisorARB(INSTOFFS_MAT0, 1);
	glVertexAttribDivisorARB(INSTOFFS_MAT1, 1);
	glVertexAttribDivisorARB(INSTOFFS_MAT2, 1);
	glVertexAttribDivisorARB(INSTOFFS_MAT3, 1);
}
