...
namespace gl
{
	...
	namespace _detail
	{
		...
		extern void (CODEGEN_FUNCPTR *DrawElementsInstancedARB)(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices, GLsizei primcount);
	...
	inline void DrawArraysInstancedARB(GLenum mode, GLint first, GLsizei count, GLsizei primcount){_detail::DrawArraysInstancedARB(mode, first, count, primcount);}
	inline void DrawElementsInstancedARB(GLenum mode, GLsizei count, GLenum type, const GLvoid * indices, GLsizei primcount){_detail::DrawElementsInstancedARB(mode, count, type, indices, primcount);}
	...
	inline void CallLists(GLsizei n, GLenum type, const GLvoid * lists){_detail::CallLists(n, type, lists);}
	...
	inline void DrawPixels(GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid * pixels){_detail::DrawPixels(width, height, format, type, pixels);}
	...
	inline void End(){_detail::End();}
	inline void EndList(){_detail::EndList();}
	...
	inline void InitNames(){_detail::InitNames();}
	...
	inline void LoadIdentity(){_detail::LoadIdentity();}
	...
	inline void PopAttrib(){_detail::PopAttrib();}
	inline void PopMatrix(){_detail::PopMatrix();}
	inline void PopName(){_detail::PopName();}
	inline void PushAttrib(GLbitfield mask){_detail::PushAttrib(mask);}
	inline void PushMatrix(){_detail::PushMatrix();}
	...
	inline void ColorPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer){_detail::ColorPointer(size, type, stride, pointer);}
	...
	inline void IndexPointer(GLenum type, GLsizei stride, const GLvoid * pointer){_detail::IndexPointer(type, stride, pointer);}
	inline void Indexub(GLubyte c){_detail::Indexub(c);}
	inline void Indexubv(const GLubyte * c){_detail::Indexubv(c);}
	inline void InterleavedArrays(GLenum format, GLsizei stride, const GLvoid * pointer){_detail::InterleavedArrays(format, stride, pointer);}
	inline GLboolean IsTexture(GLuint texture){return _detail::IsTexture(texture);}
	inline void NormalPointer(GLenum type, GLsizei stride, const GLvoid * pointer){_detail::NormalPointer(type, stride, pointer);}
	inline void PolygonOffset(GLfloat factor, GLfloat units){_detail::PolygonOffset(factor, units);}
	inline void PopClientAttrib(){_detail::PopClientAttrib();}
	...
	inline void TexCoordPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer){_detail::TexCoordPointer(size, type, stride, pointer);}
	...
	inline void VertexPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer){_detail::VertexPointer(size, type, stride, pointer);}
	...
	inline void FogCoordPointer(GLenum type, GLsizei stride, const GLvoid * pointer){_detail::FogCoordPointer(type, stride, pointer);}
	...
	inline void SecondaryColorPointer(GLint size, GLenum type, GLsizei stride, const GLvoid * pointer){_detail::SecondaryColorPointer(size, type, stride, pointer);}
