...
void InstanceBuffer::Bind() {
	...
	gl::glVertexAttribDivisor(INSTOFFS_MAT0, 1);
	gl::glVertexAttribDivisor(INSTOFFS_MAT1, 1);
	gl::glVertexAttribDivisor(INSTOFFS_MAT2, 1);
	gl::glVertexAttribDivisor(INSTOFFS_MAT3, 1);
}
