...
void (CODEGEN_FUNCPTR *_ptrc_glClearNamedFramebufferfi)(GLuint framebuffer, GLenum buffer, const GLfloat depth, GLint stencil) = NULL;
...
static int Load_ARB_direct_state_access(void)
{
	...
	_ptrc_glClearNamedFramebufferfi = (void (CODEGEN_FUNCPTR *)(GLuint, GLenum, const GLfloat, GLint))IntGetProcAddress("glClearNamedFramebufferfi");
...
static ogl_StrToExtMap ExtensionMap[56] = {
...
static int g_extensionMapSize = 56;
