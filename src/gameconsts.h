...
static const double LIGHT_SPEED = 299792458.0; // m/sec
...
static const double SOL_RADIUS = 6.957e8; // m
static const double SOL_MASS = 1.98847e30; // Kg

static const double AU = 149597870700.0; // m
static const double G = 6.67428e-11;

static const double EARTH_ATMOSPHERE_SURFACE_DENSITY = 1.225;
static const double GAS_CONSTANT_R = 8.31446261815324;
