...
const CustomSBody sol_system[] = {
	...
	{ "Mercury", SBody::TYPE_PLANET_TERRESTRIAL,
	  ...
	  fixed(387,1000), fixed(205,1000), { (float)DEG2RAD(7.0) }, fixed(59,1),
       	  FIXED_DEG2RAD(1,100),
	  { fixed(8,10), fixed(0,1), fixed(0,1), fixed(2,100), fixed(0,1), fixed(0,1), fixed(0,1) }
	},
	{ "Venus", SBody::TYPE_PLANET_TERRESTRIAL,
	  ...
	  fixed(723,1000), fixed(7,1000), { (float)DEG2RAD(3.39) }, fixed(243,1),
          FIXED_DEG2RAD(26,10),
	  { fixed(1,2), fixed(93,1), fixed(0,1), fixed(0,1), fixed(8,10), fixed(1,1), fixed(0,1) }
	},
	{ "Earth", SBody::TYPE_PLANET_TERRESTRIAL,
	  0, fixed(1,1), fixed(1,1), 288,
	  fixed(1,1), fixed(167,10000), {}, fixed(1,1), FIXED_DEG2RAD(2344,100),
	  { fixed(1,2), fixed(1,1), fixed(7,10), fixed(3,100), fixed(1,10), fixed(8,10), fixed(9,10) },
	  ECON_INDUSTRY, "data/earth.hmap"
	},
	...
	{ "Mars", SBody::TYPE_PLANET_TERRESTRIAL,
	  ...
	  FIXED_DEG2RAD(2519,100),
	  // XXX copy earth until there's a way to indicate terraformed
	  { fixed(1,2), fixed(1,1), fixed(7,10), fixed(3,100), fixed(1,10), fixed(8,10), fixed(9,10) },
	  ECON_INDUSTRY, },
