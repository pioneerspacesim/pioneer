...
static PlainVertex curvetestvtx1[] = {
	{ VTYPE_PLAIN, { -50.0f, 50.0f, 0.0f } },			// 6
	{ VTYPE_PLAIN, { -50.0f, -50.0f, 0.0f } },
	{ VTYPE_PLAIN, { 50.0f, -50.0f, 0.0f } },
	{ VTYPE_PLAIN, { 50.0f, 50.0f, 0.0f } },

	{ VTYPE_PLAIN, { 100.0f, 30.0f, 30.0f } },			//10
	{ VTYPE_PLAIN, { 100.0f, -30.0f, -30.0f } },
	{ VTYPE_PLAIN, { -100.0f, -30.0f, 30.0f } },
	{ VTYPE_PLAIN, { -100.0f, 30.0f, -30.0f } },
};
...
static PlainVertex curvetestvtx1[] = {
	...
	{ VTYPE_PLAIN, { -70.0f, -120.0f, 60.0f } },			// 9
	{ VTYPE_PLAIN, { -70.0f, -120.0f, -60.0f } },
	{ VTYPE_PLAIN, { 140.0f, 0.0f, 60.0f } },			// 11
	{ VTYPE_PLAIN, { 140.0f, 0.0f, -60.0f } },
	{ VTYPE_PLAIN, { -70.0f, 120.0f, 60.0f } },			// 13
	{ VTYPE_PLAIN, { -70.0f, 120.0f, -60.0f } },
};
static CompoundVertex curvetestvtx2[] = {
	{ VTYPE_CROSS, { 0, 1, 2, -1, -1 } },			// dummy
...
static uint16 ship2data_lowlod[] = {
	PTYPE_MATVAR, 0,
	PTYPE_COMPSMOOTH | RFLAG_XREF, 0x8000, 0, 26, 27, 6, 7,		// front edge
		COMP_HERM_NOTAN, 8, 9,
		COMP_HERMITE, 16, 1, 37, 38,
		COMP_HERMITE, 14, 1, 49, 48,
		COMP_HERMITE, 6, 7, 41, 42,
		COMP_END,
	PTYPE_COMPSMOOTH | RFLAG_XREF, 0x8000, 0, 28, 29, 8, 9,		// mid edge
		COMP_HERM_NOTAN, 10, 11,
		COMP_HERMITE, 22, 1, 37, 38,
		COMP_HERM_NOTAN, 16, 1,
		COMP_HERMITE, 8, 9, 43, 44,
		COMP_END,
	PTYPE_COMPSMOOTH | RFLAG_XREF, 0x8000, 0, 30, 31, 10, 11,		// rear edge
		COMP_HERMITE, 12, 13, 53, 54, 
		COMP_HERMITE, 22, 1, 39, 40,
		COMP_HERMITE, 10, 11, 43, 44,
		COMP_END,
	PTYPE_COMPFLAT | RFLAG_XREF, 0x8000, 0, 32, 1, 16, 1,		// centre
		COMP_HERM_NOTAN, 22, 1,
		COMP_HERMITE, 24, 1, 59, 60,
		COMP_HERM_NOTAN, 18, 1,
		COMP_HERMITE, 16, 1, 47, 51, 
		COMP_END,
	PTYPE_COMPSMOOTH | RFLAG_XREF, 0x8000, 0, 34, 1, 22, 23,		// nacelle
		COMP_HERMITE, 12, 3, 45, 46,
		COMP_HERM_NOTAN, 35, 3,
		COMP_HERMITE, 61, 1, 57, 63,
		COMP_HERMITE, 36, 0, 63, 58,
		...
		COMP_END,
	PTYPE_MATVAR, 2,
	PTYPE_COMPFLAT | RFLAG_XREF, 0x8000, 0, 70, 4, 12, 4,		// rear underside
		COMP_HERMITE, 10, 4, 56, 55, 
		COMP_LINE, 71, 4,
		COMP_LINE, 12, 4,
		COMP_END,
	...
	PTYPE_TRIFLAT | RFLAG_XREF, 12, 68, 35,
	PTYPE_QUADFLAT | RFLAG_XREF, 66, 67, 69, 68,
	PTYPE_COMPFLAT | RFLAG_XREF, 0x8000, 0, 72, 2, 36, 2,		// engine back face
		COMP_HERMITE, 61, 2, 57, 62, 
		COMP_HERMITE, 35, 2, 62, 58,
		COMP_LINE, 68, 2,
		COMP_LINE, 69, 2,
	...
	PTYPE_MATFIXED, 30, 30, 30, 30, 30, 30, 200, 0, 0, 0,
	PTYPE_COMPSMOOTH, 0x8000, 0, 33, 1, 16, 0,		// cockpit
		COMP_HERMITE, 18, 2, 52, 48,
		COMP_HERMITE, 20, 0, 48, 51,
		COMP_HERMITE, 14, 5, 49, 47,
		COMP_HERMITE, 16, 3, 47, 50, 
	...
	PTYPE_ZBIAS, 72, 2, 1,
	PTYPE_MATFIXED, 30, 30, 30, 30, 30, 30, 200, 0, 0, 0,
	PTYPE_TUBE | RFLAG_XREF, 0x8000, 4, 72, 76, 1, 250, 200,
	PTYPE_MATANIM, AFUNC_THRUSTPULSE,
		0, 0, 0, 0, 0, 0, 100, 50, 50, 100,
		0, 0, 0, 0, 0, 0, 100, 0, 0, 50,
	PTYPE_CIRCLE | RFLAG_XREF, 0x8000, 4, 72, 2, 1, 200,
...
Model ship2model = { 1.0f, 35.0f, 100, ship2vtx1, 120, 1, ship2vtx2, 10,
	{ 
		{ 2, ship2data_lowlod, 0, 14, ship2thruster },
