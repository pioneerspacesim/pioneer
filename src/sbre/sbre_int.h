...
enum animfunc
{
	...
	AFUNC_HOUR,
	AFUNC_HALFDAY,
	AFUNC_STATION_OPEN_PORT1,
	AFUNC_STATION_OPEN_PORT2,
	AFUNC_STATION_OPEN_PORT3,
	AFUNC_STATION_OPEN_PORT4,
	AFUNC_STATION_DOCK_PORT1,
	AFUNC_STATION_DOCK_PORT2,
	AFUNC_STATION_DOCK_PORT3,
	AFUNC_STATION_DOCK_PORT4,
};
...
const AnimFunc pAFunc[] =
{
	...
	{ ASRC_STATION_OPEN_PORT1, AMOD_MOD1, 0.0f, 1.0f, 0.0f, 0.0f },
	{ ASRC_STATION_OPEN_PORT2, AMOD_MOD1, 0.0f, 1.0f, 0.0f, 0.0f },
	{ ASRC_STATION_OPEN_PORT3, AMOD_MOD1, 0.0f, 1.0f, 0.0f, 0.0f },
	{ ASRC_STATION_OPEN_PORT4, AMOD_MOD1, 0.0f, 1.0f, 0.0f, 0.0f },
	{ ASRC_STATION_DOCK_PORT1, AMOD_MOD1, 0.0f, 1.0f, 0.0f, 0.0f },
	{ ASRC_STATION_DOCK_PORT2, AMOD_MOD1, 0.0f, 1.0f, 0.0f, 0.0f },
	{ ASRC_STATION_DOCK_PORT3, AMOD_MOD1, 0.0f, 1.0f, 0.0f, 0.0f },
	{ ASRC_STATION_DOCK_PORT4, AMOD_MOD1, 0.0f, 1.0f, 0.0f, 0.0f },
};
