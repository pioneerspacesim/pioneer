...
public:
	...
	static void ToJson(Json::Value &jsonObj, Frame *f, Space *space); // npw - new code
	...
	static Frame *FromJson(const Json::Value &jsonObj, Space *space, Frame *parent, double at_time); // npw - new code (under construction)
