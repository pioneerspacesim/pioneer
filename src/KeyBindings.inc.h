...
BINDING_GROUP(Lang::GALAXYMAP)
KEY_BINDING(viewForward, "BindViewForward", Lang::GAL_VIEW_FORWARD, SDLK_PAGEUP)
KEY_BINDING(viewBackward, "BindViewBackward", Lang::GAL_VIEW_BACKWARD, SDLK_PAGEDOWN)
KEY_BINDING(rotateForward, "BindRotateForward", Lang::GAL_ROTATE_FORWARD, SDLK_w)
KEY_BINDING(rotateBackward, "BindRotateBackward", Lang::GAL_ROTATE_BACKWARD, SDLK_s)
KEY_BINDING(rotateClockwise, "BindRotateClockwise", Lang::GAL_ROTATE_CLOCKWISE, SDLK_d)
KEY_BINDING(rotateCounterClockwise, "BindRotateCounterClockwise", Lang::GAL_ROTATE_COUNTER_CLOCKWISE, SDLK_a)
KEY_BINDING(galZoomIn, "BindGalZoomIn", Lang::GAL_ZOOM_IN, SDLK_EQUALS)
KEY_BINDING(galZoomOut, "BindGalZoomOut", Lang::GAL_ZOOM_OUT, SDLK_MINUS)
KEY_BINDING(galMoveUp, "BindGalMoveUp", Lang::GAL_MOVE_UP, SDLK_UP)
KEY_BINDING(galMoveDown, "BindGalMoveDown", Lang::GAL_MOVE_DOWN, SDLK_DOWN)
KEY_BINDING(galMoveLeft, "BindGalMoveLeft", Lang::GAL_MOVE_LEFT, SDLK_LEFT)
KEY_BINDING(galMoveRight, "BindGalMoveRight", Lang::GAL_MOVE_RIGHT, SDLK_RIGHT)
KEY_BINDING(galLockTarget, "BindGalLockTarget", Lang::GAL_LOCK_TARGET, SDLK_SPACE)
KEY_BINDING(galDetailToggle, "BindGalDetailToggle", Lang::GAL_DETAIL_TOGGLE, SDLK_TAB)
KEY_BINDING(galSelectToggle, "BindGalSelectToggle", Lang::GAL_SELECT_TOGGLE, SDLK_RETURN)
KEY_BINDING(galResetZoom, "BindGalResetZoom", Lang::GAL_RESET_ZOOM, SDLK_r)
KEY_BINDING(galSearch, "BindGalSearch", Lang::GAL_SEARCH, SDLK_SLASH)
KEY_BINDING(galCurrentTarget, "BindGalCurrentTarget", Lang::GAL_CURRENT_TARGET, SDLK_c)
KEY_BINDING(galSelectedTarget, "BindGalSelectedTarget", Lang::GAL_SELECTED_TARGET, SDLK_g)
KEY_BINDING(galHyperspaceTarget, "BindGalHyperspaceTarget", Lang::GAL_HYPERSPACE_TARGET, SDLK_h)
