...
double SystemBody::GetPlanckBrightness(const double wavelength_nm, const int temperature) const
{
	// Planck's constant
	double h = 6.62607015e-34; // kg*m^2*s^-1 (J*s)

	// speed of light
	double c = 299792458; // m*s^2
