...
void EquipSet::InitSlotSizes(const ShipType::Id &t)
{
...
int EquipSet::GetSlotSize(Equip::Slot s) const
{
	return equip[s].size();
}

Equip::Type EquipSet::Get(Equip::Slot s) const
{
	return Get(s, 0);
}

Equip::Type EquipSet::Get(Equip::Slot s, int idx) const
{
	assert(idx >= 0);
...
bool EquipSet::Set(Equip::Slot s, int idx, Equip::Type e)
{
	assert(idx >= 0);
...
int EquipSet::Add(Equip::Type e, int num)
{
	return ChangeType(Equip::NONE, e, num);
}

int EquipSet::Add(Equip::Type e)
{
	return Add(e, 1);
}

// returns number removed
int EquipSet::Remove(Equip::Type e, int num)
{
	return ChangeType(e, Equip::NONE, num);
}

int EquipSet::Count(Equip::Slot s, Equip::Type e) const
{
	assert(e < Equip::TYPE_MAX);
	int num = 0;
...
int EquipSet::FreeSpace(Equip::Slot s) const
{
	return Count(s, Equip::NONE);
}

int EquipSet::ChangeType(Equip::Type from, Equip::Type to, int num)
{
	assert(num >= 0);
