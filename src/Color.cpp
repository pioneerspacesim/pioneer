...
const Color4f Color4f::DARKBLUE  = Color4f(0.0f, 0.0f, 0.5f, 1.f);
...
const Color4ub Color::DARKBLUE  = Color(0, 0, 128, 255);
...
const Color3ub Color3ub::DARKBLUE  = Color3ub(0, 0, 128);
