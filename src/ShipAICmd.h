...
public:
	...
	AICmdDock(const Json::Value &jsonObj) :
...
public:
	...
	AICmdFlyTo(const Json::Value &jsonObj) :
...
public:
	...
	AICmdFlyAround(const Json::Value &jsonObj) :
...
public:
	...
	AICmdKill(const Json::Value &jsonObj) :
...
public:
	...
	AICmdKamikaze(const Json::Value &jsonObj) :
...
public:
	...
	AICmdHoldPosition(const Json::Value &jsonObj) :
...
public:
	...
	AICmdFormation(const Json::Value &jsonObj) :
