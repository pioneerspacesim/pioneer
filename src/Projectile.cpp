...
Projectile::Projectile(): Body()
{
	...
	//set up materials
	m_sideMat.texture0 = Graphics::TextureBuilder::Billboard(projectileTextureFilename).GetOrCreateTexture(Pi::renderer);
	m_sideMat.unlit = true;
	m_sideMat.twoSided = true;
	m_glowMat.texture0 = Graphics::TextureBuilder::Billboard(projectileGlowTextureFilename).GetOrCreateTexture(Pi::renderer);
