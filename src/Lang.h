...
DECLARE_STRING(PLANET_DETAIL_LEVEL);
...
DECLARE_STRING(SECTOR_X_Y);
DECLARE_STRING(DISTANCE_FUEL_TIME);
DECLARE_STRING(CURRENT_SYSTEM);
DECLARE_STRING(DISTANCE_FUEL_REQUIRED);
DECLARE_STRING(DISTANCE_OUT_OF_RANGE);
DECLARE_STRING(CANNOT_HYPERJUMP_WITHOUT_WORKING_DRIVE);
...
DECLARE_STRING(SET_HYPERSPACE_TARGET_TO);
