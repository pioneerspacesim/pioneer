...
DECLARE_STRING(FEDERAL_RANK);
DECLARE_STRING(IMPERIAL_RANK);
...
DECLARE_STRING(FED_NONE);
DECLARE_STRING(FED_PRIVATE);
DECLARE_STRING(FED_CORPORAL);
DECLARE_STRING(FED_SERGEANT);
DECLARE_STRING(FED_SGT_MAJOR);
DECLARE_STRING(FED_MAJOR);
DECLARE_STRING(FED_COLONEL);
DECLARE_STRING(FED_LIEUTENANT);
DECLARE_STRING(FED_LT_COMMANDER);
DECLARE_STRING(FED_CAPITAN);
DECLARE_STRING(FED_COMMODORE);
DECLARE_STRING(FED_REAR_ADMIRAL);
DECLARE_STRING(FED_ADMIRAL);
DECLARE_STRING(IMP_OUTSIDER);
DECLARE_STRING(IMP_SERF);
DECLARE_STRING(IMP_MASTER);
DECLARE_STRING(IMP_SIR);
DECLARE_STRING(IMP_SQUIRE);
DECLARE_STRING(IMP_LORD);
DECLARE_STRING(IMP_BARON);
DECLARE_STRING(IMP_VISCOUNT);
DECLARE_STRING(IMP_COUNT);
DECLARE_STRING(IMP_EARL);
DECLARE_STRING(IMP_MARQUIS);
DECLARE_STRING(IMP_DUKE);
DECLARE_STRING(IMP_PRINCE);
...
DECLARE_STRING(MESSAGE_FROM_IMPERIAL_NAVY);
DECLARE_STRING(IMPERIAL_NAVY_PROMOTION_MESSAGE);
DECLARE_STRING(MESSAGE_FROM_FEDERAL_MILITARY);
DECLARE_STRING(FEDERAL_MILITARY_PROMOTION_MESSAGE);
DECLARE_STRING(DEMOTE_MESSAGE);
