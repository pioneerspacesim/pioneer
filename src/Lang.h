...
DECLARE_STRING(INCREASE_AUTO_PARAMETER);
DECLARE_STRING(DECREASE_AUTO_PARAMETER);
...
DECLARE_STRING(COMPUTER_ALTITUDE_CONTROL);
...
DECLARE_STRING(SET_ALTITUDE_KM);
DECLARE_STRING(SET_ALTITUDE_M);
