...
DECLARE_STRING(HYPERSPACE_X_CLOUD);
DECLARE_STRING(SHIP_MASS_N_TONNES);
DECLARE_STRING(DATE_DUE_N);
DECLARE_STRING(ARRIVAL);
DECLARE_STRING(DEPARTURE);
...
DECLARE_STRING(LOCK_HYPERSPACE_TARGET);
DECLARE_STRING(TOGGLE_INFO_BOX);
DECLARE_STRING(TOGGLE_SELECTION_MODE);
DECLARE_STRING(RESET_ROTATION_AND_ZOOM);
DECLARE_STRING(MOVE_LEFT);
DECLARE_STRING(MOVE_RIGHT);
DECLARE_STRING(MOVE_FORWARD);
DECLARE_STRING(MOVE_BACKWARD);
DECLARE_STRING(MOVE_UP);
DECLARE_STRING(MOVE_DOWN);
DECLARE_STRING(TURN_LEFT);
DECLARE_STRING(TURN_RIGHT);
DECLARE_STRING(TURN_UP);
DECLARE_STRING(TURN_DOWN);
