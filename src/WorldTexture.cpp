...
WorldTextureDescriptor::WorldTextureDescriptor(const std::string &_filename) :
	Graphics::TextureDescriptor(TARGET_2D, Format(Format::INTERNAL_RGBA, Format::DATA_RGBA, Format::DATA_UNSIGNED_BYTE), Options(Options::REPEAT, Options::LINEAR, true)),
	filename(_filename)
{
}
