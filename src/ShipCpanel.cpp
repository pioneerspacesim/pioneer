...
//	Gui::RadioGroup *g = new Gui::RadioGroup();
	...
	cam_button->AddState(WorldView::CAM_REAR, PIONEER_DATA_DIR "/icons/cam_rear.png", PIONEER_DATA_DIR "/icons/cam_rear_on.png", PiLang::REAR_VIEW);
	cam_button->AddState(WorldView::CAM_EXTERNAL, PIONEER_DATA_DIR "/icons/cam_external.png", PIONEER_DATA_DIR "/icons/cam_external_on.png", PiLang::EXTERNAL_VIEW);
	...
	map_button->AddState(0, PIONEER_DATA_DIR "/icons/cpan_f2_map.png", PIONEER_DATA_DIR "/icons/cpan_f2_map_on.png", PiLang::NAVIGATION_STAR_MAPS);
	...
	info_button->AddState(0, PIONEER_DATA_DIR "/icons/cpan_f3_shipinfo.png", PIONEER_DATA_DIR "/icons/cpan_f3_shipinfo_on.png", PiLang::SHIP_INFORMATION);
	...
	comms_button->AddState(0, PIONEER_DATA_DIR "/icons/comms_f4.png", PIONEER_DATA_DIR "/icons/comms_f4_on.png", PiLang::COMMS);
	...
	b->SetToolTip(PiLang::GALAXY_SECTOR_VIEW);
	Add(b, 674, 56);
	...
	b->SetToolTip(PiLang::SYSTEM_ORBIT_VIEW);
	Add(b, 706, 56);
	...
	b->SetToolTip(PiLang::STAR_SYSTEM_INFORMATION);
	Add(b, 738, 56);
...
{
	MsgLog()->ImportantMessage(s->GetLabel(), PiLang::DOCKING_CLEARANCE_EXPIRED);
}
