...
float Pi::CalcHyperspaceRange(int hyperclass, int total_mass_in_tonnes)
{
	...
	// Irigi: Increasing the ship's fuel tank masses and including the fuel into
	// hyperspace range calculations required change of these 60% to 32%
	return 200.0f * hyperclass * hyperclass / (total_mass_in_tonnes * 0.32f);
}
