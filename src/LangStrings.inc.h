...
DECLARE_STRING(MISSILE_DETECTED)
...
DECLARE_STRING(CLEARANCE_DENIED_TOO_FAR)
...
DECLARE_STRING(LAWLESSNESS)
DECLARE_STRING(LL_ALMOST_NON_EXISTENT)
DECLARE_STRING(LL_VERY_SAFE)
DECLARE_STRING(LL_SAFE)
DECLARE_STRING(LL_MODERATE)
DECLARE_STRING(LL_HIGH)
DECLARE_STRING(LL_VERY_HIGH)
DECLARE_STRING(LL_EXTREME)
