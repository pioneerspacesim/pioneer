...
DECLARE_STRING(RETURN_TO_MENU)
DECLARE_STRING(WINDOW_OR_FULLSCREEN)
DECLARE_STRING(FULL_SCREEN)
DECLARE_STRING(COMPRESS_TEXTURES)
...
DECLARE_STRING(HUD)
DECLARE_STRING(DISPLAY_NAV_TUNNEL)
...
DECLARE_STRING(FREE)
DECLARE_STRING(FREE_LOWERCASE)
DECLARE_STRING(USED)
DECLARE_STRING(FUEL_WEIGHT)
...
DECLARE_STRING(GALAXYMAP)
DECLARE_STRING(GAL_VIEW_FORWARD)
DECLARE_STRING(GAL_VIEW_BACKWARD)
DECLARE_STRING(GAL_ROTATE_FORWARD)
DECLARE_STRING(GAL_ROTATE_BACKWARD)
DECLARE_STRING(GAL_ROTATE_CLOCKWISE)
DECLARE_STRING(GAL_ROTATE_COUNTER_CLOCKWISE)
DECLARE_STRING(GAL_ZOOM_IN)
DECLARE_STRING(GAL_ZOOM_OUT)
DECLARE_STRING(GAL_MOVE_UP)
DECLARE_STRING(GAL_MOVE_DOWN)
DECLARE_STRING(GAL_MOVE_LEFT)
DECLARE_STRING(GAL_MOVE_RIGHT)
DECLARE_STRING(GAL_LOCK_TARGET)
DECLARE_STRING(GAL_DETAIL_TOGGLE)
DECLARE_STRING(GAL_SELECT_TOGGLE)
DECLARE_STRING(GAL_RESET_ZOOM)
DECLARE_STRING(GAL_SEARCH)
DECLARE_STRING(GAL_CURRENT_TARGET)
DECLARE_STRING(GAL_SELECTED_TARGET)
DECLARE_STRING(GAL_HYPERSPACE_TARGET)
