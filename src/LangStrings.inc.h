...
DECLARE_STRING(ICE_MOON)
DECLARE_STRING(ROCKY_PLANET)
DECLARE_STRING(ROCKY_MOON)
DECLARE_STRING(OCEANICWORLD)
DECLARE_STRING(OCEANICMOON)
DECLARE_STRING(PLANET_CONTAINING_LIQUID_WATER)
DECLARE_STRING(MOON_CONTAINING_LIQUID_WATER)
DECLARE_STRING(PLANET_WITH_SOME_ICE)
DECLARE_STRING(MOON_WITH_SOME_ICE)
DECLARE_STRING(ROCKY_PLANET_CONTAINING_COME_LIQUIDS)
DECLARE_STRING(DWARF_PLANET_CONTAINING_LIQUID_WATER)
DECLARE_STRING(DWARF_PLANET_CONTAINING_SOME_LIQUIDS)
DECLARE_STRING(DWARF_PLANET_MOSTLY_COVERED_IN_ICE)
DECLARE_STRING(DWARF_PLANET_TERRESTRIAL)
DECLARE_STRING(ICE_DWARF_PLANET)
DECLARE_STRING(ROCKY_MOON_CONTAINING_SOME_LIQUIDS)
...
DECLARE_STRING(AN_O2_ATMOSPHERE)
DECLARE_STRING(CO2_ATMOSPHERE)
DECLARE_STRING(A_CO2_ATMOSPHERE)
DECLARE_STRING(CO_ATMOSPHERE)
DECLARE_STRING(A_CO_ATMOSPHERE)
DECLARE_STRING(CH4_ATMOSPHERE)
DECLARE_STRING(A_CH4_ATMOSPHERE)
DECLARE_STRING(H_ATMOSPHERE)
DECLARE_STRING(A_H_ATMOSPHERE)
DECLARE_STRING(HE_ATMOSPHERE)
DECLARE_STRING(A_HE_ATMOSPHERE)
DECLARE_STRING(AR_ATMOSPHERE)
DECLARE_STRING(AN_AR_ATMOSPHERE)
DECLARE_STRING(S_ATMOSPHERE)
DECLARE_STRING(A_S_ATMOSPHERE)
DECLARE_STRING(N_ATMOSPHERE)
DECLARE_STRING(A_N_ATMOSPHERE)
...
DECLARE_STRING(MASS)
DECLARE_STRING(N_EARTH_MASSES)
DECLARE_STRING(N_SOLAR_MASSES)
DECLARE_STRING(N_EARTH_RADII)
DECLARE_STRING(N_SOLAR_RADII)
DECLARE_STRING(SURFACE_TEMPERATURE)
DECLARE_STRING(SURFACE_GRAVITY)
DECLARE_STRING(ESCAPE_VELOCITY)
DECLARE_STRING(MEAN_DENSITY)
