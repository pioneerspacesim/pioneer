...
DECLARE_STRING(DWARF_ICE_PLANET)
DECLARE_STRING(DWARF_PLANET)
DECLARE_STRING(WATER_DWARF_PLANET)
DECLARE_STRING(DWARF_PLANET_CONTAINING_LIQUID_WATER)
DECLARE_STRING(DWARF_PLANET_WITH_SOME_ICE)
DECLARE_STRING(ROCKY_DWARF_PLANET_CONTAINING_SOME_LIQUIDS)
DECLARE_STRING(ROCKY_DWARF_PLANET)
