...
define_model('green_bubble', {
	...
	dynamic = function(lod)
		--pulsating glow
		if lod > 1 then
			set_material('glow2',lerp_materials(get_arg(ARG_ALL_TIME_SECONDS)*0.3, {0,0,0,1,0,0,0,0,1.6,1.9,0},
...
define_model('blue_bubble', {
	...
	dynamic = function(lod)
		if lod > 1 then
			set_material('glow2',lerp_materials(get_arg(ARG_ALL_TIME_SECONDS)*0.3, {0,0,0,1,0,0,0,0,2.5,1,1.5},
...
define_model('advert_0', {
	...
	dynamic = function(lod)
		if lod > 1 then
			set_material('glow2',lerp_materials(get_arg(ARG_ALL_TIME_SECONDS)*2, {0,0,0,1,0,0,0,0,1.6,1.9,0},
...
define_model('pink_obelisk', {
	...
	dynamic = function(lod)
		if lod > 1 then
			set_material('glow2',lerp_materials(get_arg(ARG_ALL_TIME_SECONDS)*0.1, {0,0,0,1,1,1,1,100,2.2,1,1.5},
