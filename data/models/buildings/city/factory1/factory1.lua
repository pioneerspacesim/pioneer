...
dynamic = function(lod)
	...
	local lightphase = math.fmod((get_time('SECONDS')*0.5), 1)
		if lightphase < .5 then
			billboard('light.png', 2, v(1,0,0), { v(13.5,50.5,-10), v(10.5,50.5,-10), v(-13.5,50.5,-10), v(-10.5,50.5,-10), v(1.5,50.5,-10), v(-1.5,50.5,-10) })
		else
			billboard('light.png', 2, v(1,0,0), { v(12,50.5,-11.5), v(12,50.5,-8.5), v(-12,50.5,-11.5), v(-12,50.5,-8.5), v(0,50.5,-11.5), v(0,50.5,-8.5) })
        end
