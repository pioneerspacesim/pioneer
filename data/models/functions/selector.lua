...
math.randomseed(tonumber(string.sub((string.gsub(reg,"%W", 1)),1,3),36))
...
preselect()
local seed1 = math.randomseed(tonumber(string.sub((string.gsub(reg,"%W", presel)),4,7),36)) --[[ generates a number from ship registration for random seed, any string is converted to a number,
...
preselect()
math.randomseed(tonumber(string.sub((string.gsub(reg,"%W", presel)),3,6),36))
...
preselect()
math.randomseed(tonumber(string.sub((string.gsub(reg,"%W", presel)),2,5),36))
...
preselect()
math.randomseed(tonumber(string.sub((string.gsub(reg,"%W", presel)),1,4),36))
