...
Translate:AddFlavour('Russian','DeliverPackage', {
  ...
  introtext = "Здравствуйте, меня зовут {name}.\n Заплачу {cash} за доставку небольшой посылки на станцию {starport} в системе {system} ({sectorx}, {sectory}, {sectorz}) .",
...
Translate:AddFlavour('Russian','DeliverPackage', {
  ...
  introtext = "Приветствую, я {name}.\n Заплачу {cash} капитану корабля за быструю доставку пакета на станцию {starport} в системе {system} ({sectorx}, {sectory}, {sectorz}) .",
...
Translate:AddFlavour('Russian','DeliverPackage', {
  ...
  introtext = "Здравствуйте, моё имя {name}. Заплачу {cash} капитану, который быстро доставит посылку на станцию {starport} в системе {system} ({sectorx}, {sectory}, {sectorz}) .",
...
Translate:AddFlavour('Russian','DeliverPackage', {
  ...
  introtext = "Здравствуйте, я {name}. Заплачу {cash} за доставку документов на станцию {starport} в системе {system} ({sectorx}, {sectory}, {sectorz}) .",
...
Translate:AddFlavour('Russian','DeliverPackage', {
  ...
  introtext = "Доброго времени суток!\n Это автоматическое сообщение от Курьерской Фирмы Bedford & {name}. Заплатим {cash} за доставку груза на станцию {starport} в системе {system} ({sectorx}, {sectory}, {sectorz}).",
