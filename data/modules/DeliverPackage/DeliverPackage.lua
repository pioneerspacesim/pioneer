...
local unserialize = function (data)
	...
	if data.VERSION then
		if data.VERSION < VERSION then
			print('Old DeliverPackage data loaded, converting...')
			-- No upgrade code yet
			print(('DeliverPackage data converted to internal version {newversion}'):interp({newversion=VERSION}))
			return
		end
		if data.VERSION > VERSION then
			error(([[DeliverPackage load error - saved game is more recent than installed files
		...
		print('Pre-versioning DeliverPackage data loaded')
	end
end
