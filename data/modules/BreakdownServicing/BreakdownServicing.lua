...
local unserialize = function (data)
	...
	if data.VERSION then
		if data.VERSION < VERSION then
			print('Old BreakdownServicing data loaded, converting...')
			-- No upgrade code yet
			print(('BreakdownServicing data converted to internal version {newversion}'):interp({newversion=VERSION}))
			return
		end
		if data.VERSION > VERSION then
			error(([[BreakdownServicing load error - saved game is more recent than installed files
		...
		print('Pre-versioning BreakdownServicing data loaded')
	end
end
