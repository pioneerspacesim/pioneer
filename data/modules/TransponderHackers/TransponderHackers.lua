...
local l = Lang.GetResource("module-transponderhacker")
...
local onCreateBB = function (station)
	...
	for i = 1,num do
		...
		if not ispolice or numPolice < maxPolice then
			...
			local flavour = string.interp(l["TRANSPONDER_HACKER_"..rand:Integer(1, num_names)-1], {name = NameGen.Surname(rand)})
			...
			-- going rate on the black market will normal since these can't be legally bought
			local e = Equipment.misc.automatic_identification_system
			ad.stock[e] = Engine.rand:Integer(5,500)
			ad.price[e] = ad.station:GetEquipmentPrice(e)
			
			e = Equipment.misc.automatic_identification_system_military
			ad.stock[e] = Engine.rand:Integer(5,500)
			ad.price[e] = ad.station:GetEquipmentPrice(e)
			
			e = Equipment.misc.automatic_identification_system_illegal
			ad.stock[e] = Engine.rand:Integer(5,500)
			ad.price[e] = ad.station:GetEquipmentPrice(e)
			
			local ref = ad.station:AddAdvert({
				description = ad.flavour,
				icon        = "transponder_hacker",
				onChat      = onChat,
				onDelete    = onDelete})
			ads[ref] = ad
		end
...
Serializer:Register("TransponderHacker", serialize, unserialize)
