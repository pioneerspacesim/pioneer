...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Добрый день! Меня зовут {name}.\n Наша группа ищет перевозчика, чтобы попасть в систему {system} ({sectorx}, {sectory}, {sectorz}). Заплатим {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Разрешите представиться - {name}.\n Ищу транспорт в систему {system} ({sectorx}, {sectory}, {sectorz}). Предлагаю {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Доброго времени суток! Я {name}.\n Хочу отправиться в систему {system} ({sectorx}, {sectory}, {sectorz}). С меня {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Привет-привет! Я {name}.\n Доставьте меня в систему {system} ({sectorx}, {sectory}, {sectorz}). Заработаете {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Приветствую! Моё имя {name}.\n Следую в систему {system} ({sectorx}, {sectory}, {sectorz}). Оплата {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Здравствуйте, я {name}.\n Готовы доставить меня в систему {system} ({sectorx}, {sectory}, {sectorz})? Цена контракта {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Здравствуйте, моё имя {name}.\n Мне надо быстро оказаться в системе {system} ({sectorx}, {sectory}, {sectorz}). Выложу {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Привет! Зови меня {name}.\n Мне надо быстро перебраться в систему {system} ({sectorx}, {sectory}, {sectorz}). Получишь {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Здрасьте, я {name}.\n Можете быстрее доставить меня в систему {system} ({sectorx}, {sectory}, {sectorz})? Даю {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Добрый день. Я {name}.\n Необходим скоростной корабль для полёта в систему {system} ({sectorx}, {sectory}, {sectorz}). За работу предлагаю {cash}.",
...
Translate:AddFlavour('Russian','Taxi', {
  ...
  introtext = "Зовите меня {name}.\n Я хочу попасть в систему {system} ({sectorx}, {sectory}, {sectorz}). Заплачу {cash}.",
