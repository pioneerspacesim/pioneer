...
define_model('pilot_3_m', {
	...
	dynamic = function(lod)
		...
		selector2()
  		if select2 < 34 then
		    texture('lmrmodels/00_sub_models/pilot1/head3_m_f.png')
		else
		    if select2 < 67 then
		        texture('lmrmodels/00_sub_models/pilot1/head3_m_f_2.png')
		    else
		        if select2 > 66 then
		            texture('lmrmodels/00_sub_models/pilot1/head3_m_f_3.png')
		        end
			end
		end
        use_material('face')
		load_obj('lmrmodels/00_sub_models/pilot1/pilot3_m_head_f.obj')
