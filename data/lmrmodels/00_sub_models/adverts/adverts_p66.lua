...
define_model('ad_cola_0', {
	...
	dynamic = function(lod)
		if lod > 3 then
			...
			use_material('glow1')
			texture('lmrmodels/00_sub_models/adverts/wtr.png', v(.5,math.sin(trans),0),v(.5,0,0),v(0,math.cos(trans),0))
			quad(v0,v1,v2,v3)
			use_material('glow2')
			zbias(1,v(0,.5,0), v(0,0,1))
			texture('lmrmodels/00_sub_models/adverts/coolcola.png', v(.5,0,0),v(.5,0,0),v(0,-1,0))
			quad(v0,v1,v2,v3)
			zbias(0)
		end
	end
...
define_model('ad_acme_0', {
	...
	dynamic = function(lod)
		if lod > 3 then
			...
			use_material('glow1')
			texture('lmrmodels/00_sub_models/adverts/wtr_x.png', v(.5,trans,0),v(.5,0,0),v(0,1,0))
			quad(v0,v1,v2,v3)

			use_material('glow2')
			zbias(1,v(0,.5,0), v(0,0,1))
			texture('lmrmodels/00_sub_models/adverts/acme_0.png', v(.5,0,0),v(.5,0,0),v(0,-1,0))
			quad(v0,v1,v2,v3)
			zbias(0)
		end
	end
...
define_model('ad_pioneer_0', {
	...
	dynamic = function(lod)
		if lod > 3 then
			...
			use_material('glow1')
			texture('lmrmodels/00_sub_models/adverts/wtr_x.png', v(math.sin(trans),math.cos(trans),0),v(.5,0,0),v(0,1,0))
			quad(v0,v1,v2,v3)
			texture('lmrmodels/00_sub_models/adverts/pioneer_0_l.png', v(.5,0,0),v(.5,0,0),v(0,-1,0))
			use_material('glow2')
			zbias(1,v(0,.5,0), v(0,0,1))
			quad(v0,v1,v2,v3)
			zbias(0)
...
define_model('ad_sirius_0', {
	...
	dynamic = function(lod)
		if lod > 3 then
			...
			use_material('glow1')
			texture('lmrmodels/00_sub_models/adverts/tie-d_b.png', v(.5,trans,0),v(.4,0,0),v(0,.05,0))
			quad(v0,v1,v2,v3)
			texture('lmrmodels/00_sub_models/adverts/sirius_2.png', v(.5,0,0),v(.5,0,0),v(0,-1,0))
			use_material('glow2')
			zbias(1,v(0,.5,0), v(0,0,1))
			quad(v0,v1,v2,v3)
			zbias(0)
