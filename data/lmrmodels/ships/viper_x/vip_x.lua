...
define_model('vipx_uc_f', {
	...
	dynamic = function(lod)
		...
		if lod > 1 then
			use_material('ncv')
			texture('lmrmodels/ships/viper_x/piston.png',v(.5,-.5*trans,0),v(1,0,0),v(0,1-.1*trans,0))
		end
		tapered_cylinder(divs,v(0,2,0),v(0,-trans,0),v(1,0,0),.2,.12)
		if lod > 1 then
			texture('lmrmodels/ships/viper_x/piston.png',v(.5,-.5*trans,0),v(1,0,0),v(0,1-.1*trans,-.3))
		end
...
define_model('vipx_uc_r', {
	...
	dynamic = function(lod)
		...
		tapered_cylinder(divs,v(0,2,0),v(0,-trans,0),v(1,0,0),.2,.12)
		if lod > 1 then
			texture('lmrmodels/ships/viper_x/piston.png',v(.5,-.5*trans,0),v(1,-.3+.05*trans,0),v(0,1-.1*trans,0))
		end
