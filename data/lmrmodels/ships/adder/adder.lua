...
define_model('adder_piston_f', {
	...
	dynamic = function(lod)
		...
		use_material('chrome')
		--texture('lmrmodels/ships/adder/steel.png')
...
define_model('adder_sub', {
	...
	dynamic = function(lod)
		...
		use_material('glow1')
		if lod > 2 then
			texture('lmrmodels/ships/adder/glow1.png', v(textrans,textrans*.25,0),v(0,.3,0),v(0,0,.5))
		else
			texture('lmrmodels/ships/adder/glow1.png', v(.5,.5,0),v(0,.3,0),v(0,0,.5))
		end
