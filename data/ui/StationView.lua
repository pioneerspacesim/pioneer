...
ui.templates.StationView = function (args)
	...
	local function cabinUpdate ()
		...
		cabinGauge:SetValue(count-player.cabin_cap)
		cabinUsedLabel:SetText(string.interp(l.CABIN_USED, { amount = count-player.cabin_cap }))
		cabinFreeLabel:SetText(string.interp(l.CABIN_FREE, { amount = player.cabin_cap}))
	end
