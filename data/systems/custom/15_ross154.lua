...
It took some debate in the Houses of Parliament to fund this project. After all, mankind started terraforming Mars about a millenieum ago, and the process is common knowledge -a "child’s play" according to some Members of Parliament.
...
The MTMRP, nicknamed "Life bomb project", aims to revolution the terraforming technology. Rather than making step-by-step improvements, the principle is to engineer a planetary catastrophe, so that the environment becomes quickly suitable for human life. Scientists are free to experiment with Ross 154's planets, which are now nicknamed after the various catastrophes they have been subjected to. 
