...
local system = CustomSystem:new('Fomalhaut', { 'STAR_A', 'BROWN_DWARF',  })
	...
	:long_desc([[To the average citizen in the Federation, war either belongs to ancient times, or to the barbaric systems on the rim of civilization. Five centuries have passed since the last major conflict, and the cold war between the Federation and the Commonwealth has always remained cold, even during the climax of the Pell incident in 3012. 
