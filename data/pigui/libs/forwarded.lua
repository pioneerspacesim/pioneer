...
ui.addCircle = pigui.AddCircle ---@type fun(center: Vector2, radius: number, col: Color, segments: integer, thickness: number)
ui.addCircleFilled = pigui.AddCircleFilled ---@type fun(center: Vector2, radius: number, col: Color, segments: integer)
