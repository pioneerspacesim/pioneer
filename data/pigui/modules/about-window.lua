...
local function showInfo()
	...
	ui.withFont(pionillium.body, function()
		...
		ui.sameLine()
		ui.textLinkOpenURL("http://pioneerspacesim.net/", "http://pioneerspacesim.net/")

		ui.bulletText(l.LINK_BUG_TRACKER)
		ui.sameLine()
		ui.textLinkOpenURL("https://github.com/pioneerspacesim/pioneer/issues/", "https://github.com/pioneerspacesim/pioneer/issues/")

		ui.bulletText(l.LINK_COMMUNITY_FORUM)
		ui.sameLine()
		ui.textLinkOpenURL("http://spacesimcentral.com/community/pioneer/", "http://spacesimcentral.com/community/pioneer/")

		ui.bulletText(l.LINK_DEVELOPER_FORUM)
		ui.sameLine()
		ui.textLinkOpenURL("https://forum.pioneerspacesim.net/", "https://forum.pioneerspacesim.net/")
...
local function showHelp()
	...
	ui.withFont(pionillium.body, function()
		...
		-- ui.bulletText("")
		-- ui.sameLine()
		-- ui.textLinkOpenURL("Keyboard and mouse control", "https://wiki.pioneerspacesim.net/wiki/Keyboard_and_mouse_controls")
	end)
end
...
local function showContribute()
	...
	ui.withFont(pionillium.body, function()
		...
		ui.bulletText("")
		ui.sameLine()
		ui.textLinkOpenURL(l.CONTRIBUTIONS, "https://wiki.pioneerspacesim.net/wiki/How_you_can_contribute")
...
local function showSoftwareUsed()
	...
	if ui.collapsingHeader(l.SOFTWARE) then
		...
		if ui.treeNode("lua") then
			...
			ui.textLinkOpenURL("https://github.com/ocornut/imgui", "https://github.com/ocornut/imgui")
			ui.treePop()
		end
		...
		if ui.treeNode("GLEW") then
			...
			ui.textLinkOpenURL("https://glew.sourceforge.net/", "https://glew.sourceforge.net/")
			ui.treePop()
		end
		...
		if ui.treeNode("PicoDDS") then
			...
			ui.textLinkOpenURL("https://github.com/fluffyfreak/PicoDDS", "https://github.com/fluffyfreak/PicoDDS")
			ui.treePop()
		end
		...
		if ui.treeNode("JSON for Modern C++") then
			...
			ui.textLinkOpenURL("https://github.com/nlohmann/json", "https://github.com/nlohmann/json")
			ui.treePop()
		end
		...
		if ui.treeNode("High Performance C++ Profiler") then
			ui.text("Licensed under the MIT license")
			ui.textLinkOpenURL("https://code.google.com/p/high-performance-cplusplus-profiler/","https://code.google.com/p/high-performance-cplusplus-profiler/")
			ui.treePop()
		end
		...
		if ui.treeNode("nanosvg") then
			...
			ui.textLinkOpenURL("https://github.com/memononen/nanosvg", "https://github.com/memononen/nanosvg")
			ui.treePop()
		end
	...
	if ui.collapsingHeader(l.CONTENT) then
		...
		if ui.treeNode("WPZOOM Developer Icon Set") then
			...
			ui.textLinkOpenURL("http://www.wpzoom.com/wpzoom/new-freebie-wpzoom-developer-icon-set-154-free-icons/", "http://www.wpzoom.com/wpzoom/new-freebie-wpzoom-developer-icon-set-154-free-icons/")
			ui.treePop()
		end

		if ui.treeNode("Galaxy colour image") then
			ui.text("Modified version (rotated/converted to PNG)")
			ui.textLinkOpenURL("http://www.spitzer.caltech.edu/images/2353-sig05-010a-Milky-Way-Bar", "http://www.spitzer.caltech.edu/images/2353-sig05-010a-Milky-Way-Bar")
		...
		if ui.treeNode("Milky Way panorama") then
			...
			ui.textLinkOpenURL("https://svs.gsfc.nasa.gov/4851", "https://svs.gsfc.nasa.gov/4851")
			ui.text("Credit:")
	...
	if ui.collapsingHeader(l.ACKNOWLEDGEMENTS) then
		...
		ui.bulletText("SDL")
		ui.sameLine()
		ui.textLinkOpenURL("http://www.libsdl.org/", "http://www.libsdl.org/")

		ui.bulletText("FreeType")
		ui.sameLine()
		ui.textLinkOpenURL("http://freetype.org/", "http://freetype.org/")

		ui.bulletText("Ogg Vorbis")
		ui.sameLine()
		ui.textLinkOpenURL("http://vorbis.com/", "http://vorbis.com/")

		ui.bulletText("libsigc++")
		ui.sameLine()
		ui.textLinkOpenURL("http://libsigc.sourceforge.net/", "http://libsigc.sourceforge.net/")

		ui.bulletText("assimp")
		ui.sameLine()
		ui.textLinkOpenURL("http://assimp.sourceforge.net/", "http://assimp.sourceforge.net/")

		ui.bulletText("MXE")
		ui.sameLine()
		ui.textLinkOpenURL("http://mxe.cc/", "http://mxe.cc/")

		ui.separator()

		ui.bulletText("GitHub")
		ui.sameLine()
		ui.textLinkOpenURL("https://github.com/", "https://github.com/")

		ui.bulletText("SourceForge")
		ui.sameLine()
		ui.textLinkOpenURL("https://sourceforge.net/", "https://sourceforge.net/")

		ui.bulletText("randomColorSharped")
		ui.sameLine()
		ui.textLinkOpenURL("https://github.com/nathanpjones/randomColorSharped", "https://github.com/nathanpjones/randomColorSharped")

		ui.separator()

		ui.bulletText("OpenGameArt")
		ui.sameLine()
		ui.textLinkOpenURL("http://opengameart.org", "http://opengameart.org")
	end
