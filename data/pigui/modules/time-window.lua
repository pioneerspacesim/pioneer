...
local button_size = vector2.new(32,32) * (ui.screenHeight / 1200)
...
local function displayTimeWindow()
	...
	ui.withFont(pionillium.large.name, pionillium.large.size, function()
								...
								local window_size = vector2.new(math.max(text_size.x, (button_size.x + frame_padding * 2 + 7) * 6) + 15, text_size.y + button_size.y + frame_padding * 2 + 20)
								ui.timeWindowSize = window_size
								ui.setNextWindowSize(window_size, "Always")
								ui.setNextWindowPos(vector2.new(0, ui.screenHeight - window_size.y), "Always")
