...
theme.colors = {
	...
	deltaVManeuverLow		= styleColors.danger_500,
	deltaVRemaining			= styleColors.warning_100,
	deltaVRemainingLow		= styleColors.warning_500,
	deltaVTotal				= styleColors.panel_600:opacity(0.75),
	brakeBackground			= styleColors.panel_600:opacity(0.75),
	brakeNotNeeded			= styleColors.accent_500,
	...
	gaugeShield				= styleColors.accent_500,
	gaugeHull				= styleColors.gray_400,
