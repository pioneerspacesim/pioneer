...
HyperdriveType.HyperjumpTo = function (self, ship, destination)
	...
	return ship:InitiateHyperjumpTo(destination, warmup_time, duration, self.sounds), fuel_use, duration
end
